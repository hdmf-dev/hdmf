...
- Allow `hdmf.common.table.DynamicTable.add_column` to accept nested lists as column data while having the function automatically create the required `VectorIndex`. @oruebel (#728)
