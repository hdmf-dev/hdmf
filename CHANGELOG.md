...
### Enhancements
- Added `TermSetConfigurator` to automatically wrap fields with `TermSetWrapper` accordding to a configuration file. @mavaylon1 [1016](https://github.com/hdmf-dev/hdmf/pull/1016)
