...
- Fixed issue with depricated `pkg_resources`. @mavaylon [822](https://github.com/hdmf-dev/hdmf/pull/822)
- Fixed `hdmf.common` deprication warning. @mavaylon [826]((https://github.com/hdmf-dev/hdmf/pull/826)
