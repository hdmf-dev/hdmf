...
- Updated ExternalResources to support reading and writing TSV files for denormalized ExternalResources table, name changes, and updates to the tutorial. @mavaylon [#799](https://github.com/hdmf-dev/hdmf/pull/799)
