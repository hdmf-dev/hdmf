...
class TestExternalResources(H5RoundTripMixin, TestCase):
    def setUpContainer(self):
        ...
        er.add_ref(file=file, container=file, key="special", entity_id="id11", entity_uri="url11")
        er.add_ref(file=file2, container=file2, key="key2", entity_id="id12", entity_uri="url12")
    ...
    def test_to_dataframe(self):
        ...
        expected_df = expected_df.astype(
            {"keys_idx": "uint32", "objects_idx": "uint32", "files_idx": "uint32", "entities_idx": "uint32"}
        )
    ...
    def test_assert_external_resources_equal(self):
        ...
        er_left.add_ref(file=file, container=ref_container_1, key="key1", entity_id="id11", entity_uri="url11")

        er_right = ExternalResources()
        er_right.add_ref(file=file, container=ref_container_1, key="key1", entity_id="id11", entity_uri="url11")
    ...
    def test_add_ref_search_for_file(self):
        ...
        er = ExternalResources()
        er.add_ref(container=em, key="key1", entity_id="entity_id1", entity_uri="entity1")
    ...
    def test_add_ref_search_for_file_parent(self):
        ...
        er = ExternalResources()
        er.add_ref(container=child, key="key1", entity_id="entity_id1", entity_uri="entity1")
        self.assertEqual(er.keys.data, [("key1",)])
        self.assertEqual(er.entities.data, [(0, "entity_id1", "entity1")])
    ...
    def test_add_ref_search_for_file_nested_parent(self):
        ...
        er = ExternalResources()
        er.add_ref(container=nested_child, key="key1", entity_id="entity_id1", entity_uri="entity1")
        self.assertEqual(er.keys.data, [("key1",)])
        self.assertEqual(er.entities.data, [(0, "entity_id1", "entity1")])
    ...
    def test_add_ref_search_for_file_error(self):
        ...
        with self.assertRaises(ValueError):
            er.add_ref(container=container, key="key1", entity_id="entity_id1", entity_uri="entity1")
    ...
    def test_get_object_type(self):
        ...
        file = ExternalResourcesManagerContainer(name="file")
        data = Data(name="species", data=["Homo sapiens", "Mus musculus"])
        er.add_ref(file=file, container=data, key="key1", entity_id="entity_id1", entity_uri="entity1")
    ...
    def test_get_entities(self):
        ...
        df = er.get_object_entities(file=file, container=data)
        expected_df_data = {"key_names": {0: "key1"}, "entity_id": {0: "entity_id1"}, "entity_uri": {0: "entity1"}}
        expected_df = pd.DataFrame.from_dict(expected_df_data)
    ...
    def test_get_entities_file_none_container(self):
        ...
        er.add_ref(container=file, key="key1", entity_id="entity_id1", entity_uri="entity1")
    ...
    def test_get_entities_attribute(self):
        ...
        er = ExternalResources()
        er.add_ref(
            file=file, container=table, attribute="col1", key="key1", entity_id="entity_0", entity_uri="entity_0_uri"
        )
        df = er.get_object_entities(file=file, container=table, attribute="col1")

        expected_df_data = {"key_names": {0: "key1"}, "entity_id": {0: "entity_0"}, "entity_uri": {0: "entity_0_uri"}}
        expected_df = pd.DataFrame.from_dict(expected_df_data)
    ...
    def test_to_and_from_norm_tsv_entity_value_error(self):
        ...
        df.at[0, "keys_idx"] = 10  # Change key_ix 0 to 10  # Change key_ix 0 to 10
    ...
    def test_to_and_from_norm_tsv_object_value_error(self):
        ...
        df.at[0, "files_idx"] = 10  # Change key_ix 0 to 10  # Change key_ix 0 to 10
    ...
    def test_to_and_from_norm_tsv_object_keys_object_idx_value_error(self):
        ...
        df.at[0, "objects_idx"] = 10  # Change key_ix 0 to 10  # Change key_ix 0 to 10
    ...
    def test_add_ref_two_keys(self):
        ...
        self.assertEqual(
            er.objects.data,
            [(0, ref_container_1.object_id, "Container", "", ""), (1, ref_container_2.object_id, "Container", "", "")],
        )
    ...
    def test_add_ref_same_keyname(self):
        ...
        self.assertEqual(er.entities.data, [(0, "id11", "url11"), (1, "id12", "url21"), (2, "id13", "url31")])
        self.assertEqual(
            er.objects.data,
            [
                (0, ref_container_1.object_id, "Container", "", ""),
    ...
    def test_check_object_field_add(self):
        er = ExternalResources()
        data = Data(name="species", data=["Homo sapiens", "Mus musculus"])
        er._check_object_field(
            file=ExternalResourcesManagerContainer(name="file"), container=data, relative_path="", field=""
        )
...
class TestExternalResourcesGetKey(TestCase):
    ...
    def test_get_key_file_container_provided(self):
        ...
        self.er.add_ref(file=file, container=container1, key="key1", entity_id="id11", entity_uri="url11")
        self.er.add_ref(
            file=file, container=Container(name="Container"), key="key1", entity_id="id12", entity_uri="url21"
        )
    ...
    def test_get_key_no_file_deep_nested_container_provided(self):
        ...
        self.er.add_ref(file=file, container=container2, key="key1", entity_id="id11", entity_uri="url11")
