...
#         er_left.add_ref(file='file_id',
#             container='uuid1', key='key1',
#             entity_id="id11", entity_uri='url11')
#
#         er_right = ExternalResources()
#         er_right.add_ref(file='file_id',
#             container='uuid1', key='key1',
#             entity_id="id11", entity_uri='url11')
#
...
#             container=data, key='key1',
#             entity_id='entity_id1', entity_uri='entity1')
#         er.to_flat_tsv(path=self.export_filename)
#         # read er back from file and compare
#         er_obj = ExternalResources.from_flat_tsv(path=self.export_filename)
#         # breakpoint()
...
#
#         self.assertEqual(er.objects.data, [(0, 'uuid1', '', ''),
#                                            (0, 'uuid2', '', '')])
#
...
#             container='uuid1', key='key1', entity_id="id11", entity_uri='url11')
#         er.add_ref(file='file_id',
#             container='uuid2', key='key1', entity_id="id12", entity_uri='url21')
#
...
#             container='uuid2', key='key1', entity_id="id12", entity_uri='url21')
#         er.add_ref(file='file_id',
#             container='uuid3', key='key1', entity_id="id13", entity_uri='url31')
#
...
#                     dtype=[('species', 'U14'), ('age', 'i4'), ('weight', 'f4')]))
#
#         er.add_ref(file='file_id',container=data, key='Mus musculus',
#                    entity_id='NCBI:txid10090',
#                    entity_uri='https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id=10090')
#         existing_key = er.get_key('Mus musculus')
#         er.add_ref(file='file_id',container=data, key=existing_key,
#                    entity_id='entity2',
...
#         er = ExternalResources()
#         data = Data(name="species", data=['Homo sapiens', 'Mus musculus'])
#         er._check_object_field(container='uuid1', file='file_id', relative_path='', field='')
#         er._check_object_field(container=data, file='file_id', relative_path='', field='')
#
#         self.assertEqual(er.objects.data, [(0, 'uuid1', '', ''), (0, data.object_id, '', '')])
#
...
#         data = Data(name="species", data=['Homo sapiens', 'Mus musculus'])
#         with self.assertRaises(ValueError):
#             er._check_object_field(container=data, file='file_id', relative_path='', field='', create=False)
#
...
#
#         er = ExternalResources()
#         er.add_ref(file='file_id',container=table,
#                    attribute='id',
#                    key='key1',
#                    entity_id='entity_0',
...
#         self.assertEqual(er.objects.data, [(0, table.id.object_id, '', '')])
#
...
#         self.assertEqual(er.keys.data, [('key1',)])
#         self.assertEqual(er.entities.data, [(0, 'entity_0', 'entity_0_uri')])
#         self.assertEqual(er.objects.data, [(0, table['col1'].object_id, '', '')])
#
...
#         er.add_ref(file='file_id',container=self.bar,
#                    attribute='attr2',
#                    key='key1',
#                    entity_id='entity_0',
#                    entity_uri='entity_0_uri')
...
#             container='uuid1', key='key1', entity_id="id11", entity_uri='url11')
#         self.er.add_ref(file='file_id',
#             container='uuid2', key='key2', entity_id="id12", entity_uri='url12')
#         self.er.add_ref(file='file_id',
#             container='uuid1', key=self.er.get_key('key1', 'uuid1', ''), entity_id="id13", entity_uri='url13')
#
#         keys = self.er.get_key('key1', 'uuid1', '')
#         self.assertIsInstance(keys, Key)
#         self.assertEqual(keys.key, 'key1')
