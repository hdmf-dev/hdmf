...
from ..helpers.utils import CORE_NAMESPACE, Foo
...
class BazScalar(Data):
    @docval(
        {"name": "name", "type": str, "doc": "the name of this BazScalar"},
...
class BuildDatasetOfReferencesMixin:
    def setUp(self):
        ...
        self.foo_spec = GroupSpec(
            ...
            data_type_def="Foo",
            datasets=[DatasetSpec(name="my_data", doc="an example dataset", dtype="int")],
            attributes=[
                AttributeSpec(
                    name="attr1",
...
class TestBuildUntypedDatasetOfReferences(BuildDatasetOfReferencesMixin, TestCase):
    ...
    def test_build(self):
        ...
        expected = DatasetBuilder(
            "MyBaz",
            [ReferenceBuilder(foo_builder), None],
            attributes={
                "baz_attr": "abcdefghijklmnopqrstuvwxyz",
                "data_type": "Baz",
                "namespace": CORE_NAMESPACE,
...
class TestBuildCompoundDatasetOfReferences(BuildDatasetOfReferencesMixin, TestCase):
    ...
    def test_build(self):
        ...
        expected = DatasetBuilder(
            "MyBaz",
            [(1, ReferenceBuilder(foo_builder))],
            attributes={
                "baz_attr": "abcdefghijklmnopqrstuvwxyz",
                "data_type": "Baz",
                "namespace": CORE_NAMESPACE,
