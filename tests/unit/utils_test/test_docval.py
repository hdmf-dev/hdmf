...
class MyChainClass(MyTestClass):
    @docval(
        {
            "name": "arg1",
            "type": (str, "MyChainClass"),
            "doc": "arg1 is a string or MyChainClass",
        },
        {
            "name": "arg2",
            "type": ("array_data", "MyChainClass"),
            "doc": "arg2 is array data or MyChainClass. it defaults to None",
            "default": None,
        },
        {
            "name": "arg3",
            "type": ("array_data", "MyChainClass"),
            "doc": "arg3 is array data or MyChainClass",
            "shape": (None, 2),
        },
        {
            "name": "arg4",
            "type": ("array_data", "MyChainClass"),
            "doc": "arg3 is array data or MyChainClass. it defaults to None.",
            "shape": (None, 2),
            "default": None,
        },
    )
...
class TestDocValidator(TestCase):
    ...
    def test_bad_type(self):
        exp_msg = (
            r"docval for arg1: error parsing argument type: argtype must be a type, "
    ...
    fmt_docval_warning_msg = (
        "fmt_docval_args will be deprecated in a future version of HDMF. Instead of"
        " using fmt_docval_args, call the function directly with the kwargs. Please"
        " note that fmt_docval_args removes all arguments not accepted by the"
        " function's docval, so if you are passing kwargs that includes extra arguments"
        " and the function's docval does not allow extra arguments (allow_extra=True is"
        " set), then you will need to pop the extra arguments out of kwargs before"
    ...
    def test_call_docval_func(self):
        ...
        msg = (
            "call_docval_func will be deprecated in a future version of HDMF. Instead"
            " of using call_docval_func, call the function directly with the kwargs."
            " Please note that call_docval_func removes all arguments not accepted by"
            " the function's docval, so if you are passing kwargs that includes extra"
            " arguments and the function's docval does not allow extra arguments"
            " (allow_extra=True is set), then you will need to pop the extra arguments"
            " out of kwargs before calling the function."
        )
        ...
        exp_kwargs = {"arg1": "a string", "arg2": 1, "arg3": True}
    ...
    def test_extra_args_pos_only(self):
        ...
        """
        msg = (
            "MyTestClass.basic_add2_kw: Expected at most 3 arguments ['arg1', 'arg2',"
            " 'arg3'], got 4: 4 positional and 0 keyword []"
        )
        with self.assertRaisesWith(TypeError, msg):
    ...
    def test_extra_args_pos_kw(self):
        ...
        msg = (
            "MyTestClass.basic_add2_kw: Expected at most 3 arguments ['arg1', 'arg2',"
            " 'arg3'], got 4: 3 positional and 1 keyword ['arg3']"
        )
        with self.assertRaisesWith(TypeError, msg):
    ...
    def test_extra_args_pos_only_ok(self):
        ...
        """
        msg = (
            "MyTestClass.basic_add2_kw_allow_extra: Expected at most 3 arguments"
            " ['arg1', 'arg2', 'arg3'], got 4 positional"
        )
        with self.assertRaisesWith(TypeError, msg):
    ...
    def test_extra_args_pos_kw_ok(self):
        ...
        self.assertDictEqual(
            kwargs,
            {"arg1": "a string", "arg2": 100, "arg3": True, "extra": "extra"},
        )
    ...
    def test_dup_kw(self):
        ...
        with self.assertRaisesWith(
            TypeError,
            "MyTestClass.basic_add2_kw: got multiple values for argument 'arg1'",
        ):
    ...
    def test_uint_type(self):
        ...
        msg = (
            "TestDocValidator.test_uint_type.<locals>.method: incorrect type for 'arg1'"
            " (got 'uint8', expected 'uint32')"
        )
        with self.assertRaisesWith(TypeError, msg):
    ...
    def test_allow_positional_warn(self):
        @docval(
            {"name": "arg1", "type": bool, "doc": "this is a bool"},
        ...
        msg = (
            "TestDocValidator.test_allow_positional_warn.<locals>.method: Using"
            " positional arguments for this method is discouraged and will be"
    ...
    def test_allow_positional_error(self):
        ...
        msg = (
            "TestDocValidator.test_allow_positional_error.<locals>.method: Only keyword"
            " arguments (e.g., func(argname=value, ...)) are allowed for this method."
        )
    ...
    def test_allow_none_false(self):
        ...
        @docval(
            {
                "name": "arg1",
                "type": bool,
                "doc": "this is a bool or None with a default",
                "default": True,
                "allow_none": False,
            }
        )
        ...
        msg = (
            "TestDocValidator.test_allow_none_false.<locals>.method: incorrect type for"
            " 'arg1' (got 'NoneType', expected 'bool')"
        )
        with self.assertRaisesWith(TypeError, msg):
    ...
    def test_enum_str(self):
        ...
        msg = (
            "TestDocValidator.test_enum_str.<locals>.method: forbidden value for 'arg1' (got 'c', expected ['a', 'b'])"
        )
        with self.assertRaisesWith(ValueError, msg):
            method(self, "c")
    ...
    def test_enum_int(self):
        ...
        msg = "TestDocValidator.test_enum_int.<locals>.method: forbidden value for 'arg1' (got 3, expected (1, 2))"
        with self.assertRaisesWith(ValueError, msg):
            method(self, 3)
    ...
    def test_enum_uint(self):
        ...
        msg = "TestDocValidator.test_enum_uint.<locals>.method: forbidden value for 'arg1' (got 3, expected (1, 2))"
        with self.assertRaisesWith(ValueError, msg):
    ...
    def test_enum_float(self):
        ...
        msg = "TestDocValidator.test_enum_float.<locals>.method: forbidden value for 'arg1' (got 3.0, expected (3.14,))"
        with self.assertRaisesWith(ValueError, msg):
            method(self, 3.0)
    ...
    def test_enum_bool_mixed(self):
        ...
        @docval(
            {
                "name": "arg1",
                "type": (bool, int, float, str, np.uint),
                "doc": "an arg",
        ...
        msg = (
            "TestDocValidator.test_enum_bool_mixed.<locals>.method: "
    ...
    def test_enum_bad_type(self):
        ...
        msg = (
            "docval for arg1: enum checking cannot be used with arg type (<class"
            " 'bool'>, <class 'int'>, <class 'str'>, <class 'numpy.float64'>, <class"
            " 'object'>)"
        )
        with self.assertRaisesWith(Exception, msg):
    ...
    def test_enum_str_default(self):
        ...
        msg = (
            "TestDocValidator.test_enum_str_default.<locals>.method: "
    ...
    def test_enum_forbidden_values(self):
        ...
        msg = (
            "docval for arg1: enum values are of types not allowed by arg type "
...
class TestDocValidatorChain(TestCase):
    ...
    def test_shape_other_unpack(self):
        ...
        err_msg = (
            r"cannot check shape of object '<object object at .*>' for argument 'arg3' "
    ...
    def test_shape_other_unpack_default(self):
        ...
        err_msg = (
            r"cannot check shape of object '<object object at .*>' for argument 'arg4' "
            r"\(expected shape '\(None, 2\)'\)"
        )
        with self.assertRaisesRegex(ValueError, err_msg):
            MyChainClass(self.obj1, [[100, 200], [300, 400], [500, 600]], arg4=obj2)
...
class TestMacro(TestCase):
    def test_macro(self):
        ...
        self.assertSetEqual(
            set(get_docval_macro().keys()),
            {"array_data", "scalar_data", "data"},
        )
        ...
        self.assertTupleEqual(
            ...
            (str, int, float, bytes, bool, Dummy1),
        )
