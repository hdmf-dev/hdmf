...
class SpecWithDupsTest(TestCase):
    ...
    def test_two_unnamed_dataset_same_type(self):
    ...
    def test_two_named_dataset_same_type(self):
    ...
    def test_two_unnamed_link_same_type(self):
    ...
    def test_two_named_link_same_type(self):
