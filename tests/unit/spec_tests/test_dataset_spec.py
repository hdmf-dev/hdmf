...
class DatasetSpecTests(TestCase):
    ...
    def test_datatype_extension_groupspec(self):
        ...
        base = GroupSpec("a fake group", data_type_def="EphysData")
    ...
    def test_constructor_default_value(self):
        spec = DatasetSpec(doc="test", default_value=5, dtype="int", data_type_def="test")
    ...
    def test_name_with_compatible_quantity(self):
        ...
        DatasetSpec(doc="my first dataset", dtype="int", name="ds1", quantity=1)
