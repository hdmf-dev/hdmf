...
from ..helpers.utils import CustomDatasetSpec, CustomGroupSpec, CustomSpecNamespace
...
class TestSpecLoadEdgeCase(TestCase):
    ...
    def test_build_namespace_missing_version(self):
        ...
        msg = (
            "Loaded namespace 'test_ns' is missing the required key 'version'. Version"
            " will be set to '%s'. Please notify the extension author."
