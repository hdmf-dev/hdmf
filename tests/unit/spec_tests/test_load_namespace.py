...
class TestCustomSpecClasses(TestCase):
    ...
    def test_load_namespaces(self):
        ...
        expected = set([
            'Data', 'Container', 'BaseDynamicTable', 'DynamicTable', 'ElementIdentifiers', 'VectorData',
            'MeaningsTable'
        ])
    ...
    def test_load_namespaces_ext(self):
        ...
        # test that the dependencies are correct, including dependencies of the dependencies
        expected_deps = set(['TestData', 'TestContainer', 'TestTable', 'Container', 'Data', 'BaseDynamicTable',
                             'DynamicTable', 'ElementIdentifiers', 'VectorData', 'MeaningsTable'])
