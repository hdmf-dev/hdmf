...
class SpecCatalogTest(TestCase):
    ...
    def test_hierarchy(self):
        spikes_spec = DatasetSpec(
            "my extending dataset",
            "int",
            data_type_inc="EphysData",
            data_type_def="SpikeData",
        )

        lfp_spec = DatasetSpec(
            "my second extending dataset",
            "int",
            data_type_inc="EphysData",
    ...
    def test_subtypes(self):
        ...
        -BaseContainer--+-->AContainer--->ADContainer
                       ...
                       +-->BContainer
        """
        base_spec = GroupSpec(doc="Base container", data_type_def="BaseContainer")
        acontainer = GroupSpec(
            doc="AContainer",
            data_type_inc="BaseContainer",
            data_type_def="AContainer",
        )
        adcontainer = GroupSpec(
            doc="ADContainer",
            data_type_inc="AContainer",
            data_type_def="ADContainer",
        )
        bcontainer = GroupSpec(
            doc="BContainer",
            data_type_inc="BaseContainer",
    ...
    def test_copy_spec_catalog(self):
        ...
        self.assertTupleEqual(self.catalog.get_registered_types(), re.get_registered_types())
