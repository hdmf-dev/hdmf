...
class TestSpec(TestCase):
    def setUp(self):
        ...
        self.ns_builder = NamespaceBuilder(
            doc="mydoc",
            name=self.ns_name,
        ...
        ext2 = GroupSpec(
            "An extension of a DataSeries interface",
            attributes=[],
            datasets=[],
            groups=[],
...
class TestNamespaceBuilder(TestSpec):
    ...
    def setUp(self):
        ...
        self.ns_builder.add_source(
            source=self.ext_source_path,
            doc="Extensions for my lab",
