    ...
    def __add_attributes(self, builder, attributes, container, build_manager, source):
        for spec in attributes:
            ...
            if isinstance(spec.dtype, RefSpec):
                ...
                #THOUGHT: Can we just pass in the Container here, and push reference resolution
                #         down to the IO layer? This would guarantee containers get built within the
                #         context that they specified.
                print("Building %s" % attr_value.name)
