...
class ObjectMapper(metaclass=ExtenderMeta):
    ...
    def __get_subspec_values(self, builder, spec, manager):
        ...
        if isinstance(spec, GroupSpec):
            ...
            data_spec = builder.resolved_spec or spec
    ...
    @staticmethod
    def __set_resolved_spec(builder, subspec):
        """Record the position-resolved subspec on the builder if not already set.
        ...
        """
        if builder.resolved_spec is None:
            builder.resolved_spec = subspec
    ...
    def construct(self, **kwargs):
        ...
        if issubclass(cls, Data):
            ...
            data_spec = builder.resolved_spec or self.spec
