...
class Builder(dict, metaclass=ABCMeta):
    @docval(
        ...
        },
        {
            "name": "parent",
            "type": "Builder",
            "doc": "the parent builder of this Builder",
            "default": None,
        },
        {
            "name": "source",
            "type": str,
            "doc": "the source of the data in this builder e.g. file name",
            "default": None,
        },
    )
...
class BaseBuilder(Builder, metaclass=ABCMeta):
    ...
    @docval(
        ...
        },
        {
            "name": "attributes",
            "type": dict,
            "doc": "A dictionary of attributes to create in this builder.",
            "default": dict(),
        },
        {
            "name": "parent",
        ...
        },
        {
            "name": "source",
            "type": str,
            "doc": "The source of the data represented in this builder",
            "default": None,
        },
    )
    def __init__(self, **kwargs):
    ...
    @docval(
        {"name": "name", "type": str, "doc": "The name of the attribute."},
...
class GroupBuilder(BaseBuilder):
    ...
    @docval(
        ...
        },
        {
            ...
            "type": (dict, list),
            "doc": (
                "A dictionary or list of subgroups to add to this group. If a dict is provided,"
        ...
        },
        {
            ...
            "type": (dict, list),
            "doc": (
                "A dictionary or list of datasets to add to this group. If a dict is provided, only"
                " the values are used."
            ),
            "default": dict(),
        },
        {
            "name": "attributes",
            "type": dict,
            "doc": "A dictionary of attributes to create in this group.",
            "default": dict(),
        },
        {
            "name": "links",
            "type": (dict, list),
            "doc": (
                "A dictionary or list of links to add to this group. If a dict is provided, only the values are used."
            ),
            "default": dict(),
        },
        {
...
class DatasetBuilder(BaseBuilder):
    ...
    @docval(
        ...
        },
        {
            ...
            "doc": "The data in this dataset.",
            "default": None,
        },
        {
            "name": "dtype",
            "type": (type, np.dtype, str, list),
            "doc": "The datatype of this dataset.",
            "default": None,
        },
        {
            "name": "attributes",
            "type": dict,
            "doc": "A dictionary of attributes to create in this dataset.",
            "default": dict(),
        },
        {
            "name": "maxshape",
            "type": (int, tuple),
            "doc": "The shape of this dataset. Use None for scalars.",
            "default": None,
        },
        {
            "name": "chunks",
            "type": bool,
            "doc": "Whether or not to chunk this dataset.",
            "default": False,
        },
        {
            "name": "parent",
        ...
        },
        {
            "name": "source",
            "type": str,
            "doc": "The source of the data in this builder.",
            "default": None,
        },
    )
    def __init__(self, **kwargs):
...
class RegionBuilder(ReferenceBuilder):
    @docval(
        {
            "name": "region",
            "type": (slice, tuple, list, RegionReference),
            "doc": "The region, i.e. slice or indices, into the target dataset.",
        },
        {
            "name": "builder",
            "type": DatasetBuilder,
            "doc": "The dataset this region reference applies to.",
        },
    )
    def __init__(self, **kwargs):
