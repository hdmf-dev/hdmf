    ...
    @docval(
        {
            "name": "outdir",
            "type": str,
            "doc": "the path to write the directory to output the namespace and specs too",
            "default": ".",
        }
    )
    ...
    def sort_keys(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            if "neurodata_type_def" not in keys and "name" in keys:
                keys.remove("name")
                keys.insert(0, "name")
            return yaml.comments.CommentedMap(yaml.compat.ordereddict([(k, self.sort_keys(obj[k])) for k in keys]))
...
class NamespaceBuilder:
    ...
    @docval(
        ...
        {"name": "name", "type": str, "doc": "Name of the namespace"},
        {
            "name": "full_name",
            "type": str,
            "doc": "Extended full name of the namespace",
            "default": None,
        },
        {
            "name": "version",
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs["version"] is None:
            ...
            # without a version
            raise ValueError(
                "Namespace '%s' missing key 'version'. Please specify a version for the extension." % kwargs["name"]
            )
    ...
    @docval(
        ...
        },
        {
            "name": "title",
            "type": str,
            "doc": "optional heading to be used for the source",
            "default": None,
        },
    )
    ...
    @docval(
        {"name": "data_type", "type": str, "doc": "the data type to include"},
        {
            "name": "source",
            "type": str,
            "doc": "the source file to include the type from",
            "default": None,
        },
        {
            "name": "namespace",
            "type": str,
            "doc": "the namespace from which to include the data type",
            "default": None,
        },
    )
    ...
    @docval(
        {"name": "path", "type": str, "doc": "the path to write the spec to"},
        {
            "name": "outdir",
            "type": str,
            "doc": "the path to write the directory to output the namespace and specs too",
        ...
        },
        {
            "name": "writer",
            "type": SpecWriter,
            "doc": "the SpecWriter to use to write the namespace",
            "default": None,
        },
    )
