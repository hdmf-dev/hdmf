...
_namespace_args = [
    ...
    {"name": "name", "type": str, "doc": "the name of this namespace"},
    {
        "name": "schema",
        "type": list,
        "doc": "location of schema specification files or other Namespaces",
    },
    {
        "name": "full_name",
        "type": str,
        "doc": "extended full name of this namespace",
        "default": None,
    },
    {
        "name": "version",
        "type": (str, tuple, list),
        "doc": "Version number of the namespace",
        "default": None,
    },
    {
        "name": "date",
    ...
    },
    {
        "name": "contact",
        "type": (str, list),
        "doc": "List of emails. Ordering should be the same as for author",
        "default": None,
    },
    {
        "name": "catalog",
        "type": SpecCatalog,
        "doc": "The SpecCatalog object for this SpecNamespace",
        "default": None,
    },
]
...
class SpecNamespace(dict):
    ...
    def __init__(self, **kwargs):
        ...
        if version is None:
            ...
            warn(
                "Loaded namespace '%s' is missing the required key 'version'. Version"
                " will be set to '%s'. Please notify the extension author." % (name, SpecNamespace.UNVERSIONED)
            )
            version = SpecNamespace.UNVERSIONED
    ...
    @docval(
        {"name": "sourcefile", "type": str, "doc": "Name of the source file"},
...
class NamespaceCatalog:
    @docval(
        {
            "name": "group_spec_cls",
            "type": type,
            "doc": "the class to use for group specifications",
            "default": GroupSpec,
        },
        {
            "name": "dataset_spec_cls",
            "type": type,
            "doc": "the class to use for dataset specifications",
            "default": DatasetSpec,
        },
        {
            "name": "spec_namespace_cls",
            "type": type,
            "doc": "the class to use for specification namespaces",
            "default": SpecNamespace,
        },
    )
    def __init__(self, **kwargs):
    ...
    def __copy__(self):
        ret = NamespaceCatalog(
            self.__group_spec_cls,
    ...
    @docval(
        {"name": "source", "type": str, "doc": "the name of the source"},
        rtype=tuple,
    )
    ...
    @docval(
        {
            "name": "namespace_path",
            "type": str,
            "doc": "the path to the file containing the namespaces(s) to load",
        },
        {
            "name": "resolve",
            "type": bool,
            "doc": "whether or not to include objects from included/parent spec objects",
            "default": True,
        },
        {
            "name": "reader",
            "type": SpecReader,
            "doc": "the class to user for reading specifications",
            "default": None,
        },
