...
from ..utils import docval, get_docval, getargs  # noqa: E402
...
@docval(
    ...
    },
    {
        "name": "namespace",
        "type": str,
        "doc": "the namespace the data_type is defined in",
    },
    is_method=False,
)
...
@docval(
    *get_docval(get_type_map),
    returns="a build manager with namespaces loaded from the given file",
    rtype=BuildManager,
    is_method=False,
)
...
@docval(
    {"name": "io", "type": HDMFIO, "doc": "the HDMFIO object to read from"},
    {
        "name": "namespace",
        "type": str,
        "doc": "the namespace to validate against",
        "default": CORE_NAMESPACE,
    },
    {
        "name": "experimental",
        "type": bool,
        "doc": "data type is an experimental data type",
        "default": False,
    },
