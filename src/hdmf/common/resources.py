...
class ExternalResources(Container):
    ...
    def to_csv(self, **kwargs):
        """
        Write ExternalResources as a single, flat table to CSV
        ...
        The CSV is formatted as follows: 1) line one is indicates for each column the name of the table
        ...
        See also :py:meth:`~hdmf.common.resources.ExternalResources.from_csv`
        """  # noqa  E501
    ...
    def from_csv(cls, **kwargs):
        """
        Read ExternalResources from a flat csv file
        Fromatting of the CSV files are assumed to consistent with the format
        generated by :py:meth:`~hdmf.common.resources.ExternalResources.to_csv`.
        The function attempts to validate that the data in the CSV is consistent.
        Currently the checks focus on ensuring that row id links between table are valid.
        ...
        .. note::
           ...
           values. While flat CSVs are sometimes preferred for ease of sharing,  editing
