...
from ..utils import AllowPositional, docval, get_data_shape, popargs, to_uint_array
...
class CSRMatrix(Container):
    @docval(
        {
            "name": "data",
            "type": (sps.csr_matrix, "array_data"),
            "doc": (
                "the data to use for this CSRMatrix or CSR data array.If passing CSR"
                " data array, *indices*, *indptr*, and *shape* must also be provided"
            ),
        },
        {
            "name": "indices",
        ...
        },
        {
            "name": "indptr",
            "type": "array_data",
            "doc": "CSR index pointer array",
            "default": None,
        },
        {
            "name": "shape",
            "type": "array_data",
            "doc": "the shape of the matrix",
            "default": None,
        },
        {
            "name": "name",
            "type": str,
            "doc": "the name to use for this when storing",
            "default": "csr_matrix",
        },
